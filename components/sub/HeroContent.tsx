    ...
    >
        <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
            ...
            <motion.p
                ...
                className='text-lg text-grey-400 my-5 max-w-[600px] text-white'
            >
                I&apos;m a fullstack developer with a passion for creating engaging and user-friendly web applications.
            </motion.p>
            <motion.a 
